...
(async () => {
  ...
  const { package64: package64 } = await encryptPackage(secretKey, data);
  console.log(typeof package64, "Encrypted package: ", package64);
  try {
  ...
  console.log(typeof sessionKey, "My key is: ", sessionKey);
  const { package64: secondResult } = await encryptPackage(sessionKey, "Hello World");
  console.log(typeof secondResult, "Second Result: ", secondResult);
  const secondDecryptedData = await decryptPackageWithKey(sessionKey, secondResult);
...
/*   const exportedsessionKey = await window.crypto.subtle.exportKey("raw", mysecretKey);
  console.log(typeof exportedsessionKey, "My exported key is: ", exportedsessionKey);
  const exportedsessionKeyBuffer = new Uint8Array(exportedsessionKey);
  console.log(typeof exportedsessionKeyBuffer, "My key buffer is: ", exportedsessionKeyBuffer);
  const exportedsessionKeyBase64 = localStorage.getItem("key");
  console.log(typeof exportedsessionKeyBase64, "My exported key: ", exportedsessionKeyBase64);
  const exportedsessionKeyBufferFromStorage = Uint8Array.fromBase64(exportedsessionKeyBase64);
  console.log(typeof exportedsessionKeyBufferFromStorage, "My key buffer from storage is: ", exportedsessionKeyBufferFromStorage); */
...
/*   const myDecryptBuffer = await crypto.subtle.decrypt(
    ...
    mysecretKey,
    exportedsessionKeyBufferFromStorage,
  );
  ...
  console.log(typeof decryptedKey, "Decrypted Key is: ", decryptedKey);
  const exportedDecryptedsessionKey = await window.crypto.subtle.exportKey("raw", decryptedKey);
  console.log(typeof exportedDecryptedsessionKey, "Exported session key is: ", exportedDecryptedsessionKey);
  const myDecryptedKeyBuffer = new Uint8Array(exportedDecryptedsessionKey);
  console.log(typeof myDecryptedKeyBuffer, "Decrypted Key Buffer is: ", myDecryptedKeyBuffer);
  const sessionKeyBase64 = myDecryptedKeyBuffer.toBase64();
  console.log(typeof sessionKeyBase64, "Session key base64 is: ", sessionKeyBase64); */
